// ===================================
// UAV COURSE - FINAL FIXED GOOGLE APPS SCRIPT
...
// Get column index by header name (1-based, returns -1 if not found)
...
// ===================================
// UTILITY: Clear all data from sheets (MANUAL USE ONLY)
// Run this once from Apps Script editor to clear all data
// ===================================
